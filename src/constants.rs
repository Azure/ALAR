...
pub(crate) static FSTAB_IMPL_FILE: &str =  include_str!("action_implementation/fstab-impl.py");
...
pub(crate) static HELPERS_PY_FILE: &str =  include_str!("action_implementation/helpers.py");
